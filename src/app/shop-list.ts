export const shop = [
    ...
    {
      id: '37fc60d7-65d0-4a08-a3d3-980086102e71',
      title: 'Iphone 13 pro max',
      description:
        'IPHONE 13 PRO MAX FICHE TECHNIQUE ET CARACTÉRISTIQUES, PRIX, AVIS, TEST, COMPARATIFS.',
      image:
    ...
    {
      id: 'e18129b9-a3d6-46e4-ab40-da7501cd571d',
      title: 'HP Pavilion Laptop 15',
      description:
        'HP Pavilion Laptop 15 FICHE TECHNIQUE ET CARACTÉRISTIQUES, PRIX, AVIS, TEST, COMPARATIFS.',
      image:
      ...
      details: [
        ...
        '8 Go de mémoire DDR4 3200 MHz (2x 4 Go)',
        'SSD M.2 PCIe de 1 To',
        'Ecran IPS de 15.6" avec résolution Full HD (1920 x 1080 pixels)',
        'Puce graphique NVIDIA GeForce MX350 avec 2 Go de mémoire dédiée',
        'Communication sans fil Wi-Fi AX + Bluetooth 5.0',
        'Haut-parleurs avec certification Bang & Olufsen et technologie HP Audio Boost',
        'Webcam HD 720p intégrée',
        'Jusqu à 8 heures d autonomie (selon l utilisation)',
      ],
    ...
    },
    {
      ...
      title: 'Hp Pc',
      description:
        "HP Pc FICHE TECHNIQUE ET CARACTÉRISTIQUES, PRIX, AVIS, TEST, COMPARATIFS.",
      image:
      ...
      details: [
        ...
        'Intel® UHD Graphics',
        '1 HDMI 1.4, 1 headphone/microphone combo, 1 RJ-45, 1 AC smart pin, 2 USB 3.1 Gen 1 Type-A (Data Transfer Only), 1 USB 3.1 Gen 1 Type-C™ (Data Transfer Only, 5 Gb/s signaling rate)',
        '1 year limited parts and labour',
      ],
      
    },
    {
      id: 'c63072f8-35bb-4994-82d9-a773b811ba61',
    ...
    },
    {
        ...
        title: 'The ipad-mini',
        description:
          "Tablette Internet 5G - Apple A15 Bionic 64 bits",
        image:
